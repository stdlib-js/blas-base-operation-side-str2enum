...
```javascript
import str2enum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-operation-side-str2enum@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-operation-side-str2enum/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-operation-side-str2enum/actions/workflows/test.yml?query=branch:v0.1.1
